...
# Declaring my working directory and working with error handling:

# Forcing to enter a valid working directory.
...
# Importing data:
try:  # Added exception handling if type of file is not '.CSV'
    ...
    dendrogram_figure = shc.dendrogram(shc.linkage(labeled_principal_components[new_features[1:2]], method='ward'))
    plt.show()
